...
const InvoiceDetail = ({ invoice }) => {
  ...
  return (
    <div className="bg-gray-200 print:bg-white p-2 sm:p-6 min-h-screen print:min-h-0">

      <div ref={pdfRef} className="invoice-print bg-white max-w-3xl mx-auto p-8 rounded shadow print:shadow-none">
        ...
        <div className="flex flex-col sm:flex-row justify-between border-b pb-4">
          <div>
            ...
            <p className="text-xs mb-2 sm:text-sm" >
        ...
        {/* desktop - ITEMS TABLE */}
        <div className="hidden md:block print:block mt-6">
        ...
        {/* mobile invoice */}
        <div className="md:hidden print:hidden mt-6 space-y-4">
          {(order.purchasedItems || []).map((item, i) => (
            <div
              key={i}
      ...
      <div className="text-center mt-6 print:hidden">
        <button
          ...
          className="px-6 py-2 rounded cursor-pointer bg-blue-500 text-white"
        >
          Download PDF
        </button>
      </div>
